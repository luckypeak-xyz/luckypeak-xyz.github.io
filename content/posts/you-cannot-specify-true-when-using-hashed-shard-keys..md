...
这是因为对哈希片键施加唯一性约束没有意义。如上所述，哈希片键基于哈希索引，而对哈希索引，或者说对哈希值施加唯一性约束是无意义的。因为，哈希值没有业务含义，同一字段上的不同值亦有可能哈希值相同。
